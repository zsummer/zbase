...
s32 LinerStress(List& l, const std::string& desc,  bool is_static, bool out_prof)
{
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "push_back").c_str(), LOAD_CAPACITY, cost.StopAndSave().cost());
        }
        if (is_static)
        {
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "clear").c_str(), 1, cost.StopAndSave().cost());
        }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "insert begin &erase begin").c_str(), LOAD_CAPACITY * 2, cost.StopAndSave().cost());
        }
    }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "insert begin").c_str(), LOAD_CAPACITY, cost.StopAndSave().cost());
        }
    }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "pop begin").c_str(), LOAD_CAPACITY, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), 0, desc + ": error");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "insert end & pop end(capacity)").c_str(), LOAD_CAPACITY * 2, cost.StopAndSave().cost());
        }
        if (is_static)
        {
            l.erase(l.end());
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "push back & pop back(capacity)").c_str(), LOAD_CAPACITY * 2, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), 0, desc + ": error");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "push back & pop back (one item)").c_str(), LOAD_CAPACITY * LOOP_CAPACITY * 2, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), 0, desc + ": error");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "push back & pop back(capacity loop 1000)").c_str(), LOAD_CAPACITY * 2 * 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), 0, desc + ": error");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "full cap copy from other(other =l):size" + std::to_string(LOAD_CAPACITY) ).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), LOAD_CAPACITY, desc + ": error");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "half cap copy from other(other =l):size" + std::to_string(LOAD_CAPACITY/2)).c_str(), 1000, cost.StopAndSave().cost());
        }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + " 1/3 cap copy from other(other =l):size" + std::to_string(LOAD_CAPACITY / 2)).c_str(), 1000, cost.StopAndSave().cost());
        }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + " 1/5 cap copy from other(other =l):size" + std::to_string(LOAD_CAPACITY / 2)).c_str(), 1000, cost.StopAndSave().cost());
        }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "empty cap copy from other(other =l):size" + std::to_string(0)).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), 0, desc + ": error");
        l.clear();
    }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "full cap std::move() from other(other =l):size" + std::to_string(LOAD_CAPACITY)).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), LOAD_CAPACITY, desc + ": error");
        l.clear();
    }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "half cap std::move() from other(other =l):size" + std::to_string(LOAD_CAPACITY / 2)).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), LOAD_CAPACITY / 2, desc + ": error");
        //ASSERT_TEST_EQ(*l.begin(), *other.begin(), "");
        //ASSERT_TEST_EQ(*l.rbegin(), *other.rbegin(), "");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + " 1/3 cap std::move() from other(other =l):size" + std::to_string(LOAD_CAPACITY / 2)).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), LOAD_CAPACITY / 3, desc + ": error");
        //ASSERT_TEST_EQ(*l.begin(), *other.begin(), "");
        //ASSERT_TEST_EQ(*l.rbegin(), *other.rbegin(), "");
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + " 1/5 cap std::move() from other(other =l):size" + std::to_string(LOAD_CAPACITY / 2)).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), LOAD_CAPACITY / 5, desc + ": error");
        l.clear();
    }
    ...
    if (true)
    {
        ...
        if (out_prof)
        {
            PROF_OUTPUT_MULTI_COUNT_CPU((ss.str() + "empty list std::move() from other(other =l):size" + std::to_string(0)).c_str(), 1000, cost.StopAndSave().cost());
        }
        ASSERT_TEST_EQ((int)l.size(), 0, desc + ": error");
        l.clear();
    }
